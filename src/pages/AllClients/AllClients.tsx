...
//       )}
//         <PaginationButtons
//             totalPages={Math.ceil(depositHistorys?.total / perPage)}
//             currentPage={currentPage}
//             setCurrentPage={setCurrentPage}
//           />
//       {/* <div>
//         <button className="px-4 py-1 bg-green-200 rounded-md">Prev</button>
//         {Array.from({ length: Math.round(50 / 3) }).map((_, i) => (
//           <span key={i} className="px-2">
//             {i + 1}
//           </span>
//         ))}
//         <button className="px-4 py-1 bg-green-200 rounded-md">Next</button>
//       </div> */}
//     </>
//   );
// };
